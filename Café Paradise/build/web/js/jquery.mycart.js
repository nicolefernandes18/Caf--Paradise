  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<a href="payment.html"><button type="button" class="btn btn-primary" id="' + idCheckoutCart + '">Checkout</button></a>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var showGrandTotal = function(products){
      ...
      $("#" + idGrandTotal).text("Rs." + total);
    }
    var showDiscountPrice = function(products){
      $("#" + idDiscountPrice).text("Rs." + options.getDiscountPrice(products));
    }
